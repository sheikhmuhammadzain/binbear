              ...
              <div className="row align-items-center">
                <div className="col-lg-12">
                  <div className="banner-premium-content" data-aos="fade-up">
                    <span className="banner-premium-badge">
                      BinBear Junk Removal
                    </span>
                    <h1 className="banner-premium-title">
                      Fast, Reliable, and Affordable Junk Removal
                    </h1>
                    <p className="banner-premium-text">
                      We are here to help you get rid of your junk. No job is
                      too big or too small for our team of experts.
                    </p>
