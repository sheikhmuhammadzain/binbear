        ...
        <div className="container">
          <div className="box-how-it-work-2 bg-brand-2 bg-how-it-work-2">
            <div className="text-center">
              <h2 className="color-white wow animate__animated animate__fadeIn">
                How It Works
              </h2>
            </div>
              ...
              <ul className="list-how-works">
                <li>
                  ...
                  <div className="info-how">
                    <h5 className="color-white wow animate__animated animate__fadeIn">
            ...
            <div className="box-button-play-2">
              <a
                className="btn btn-play popup-youtube hover-up"
                onClick={() => setOpen(true)}
              >
                <img
                  src="/assets/imgs/page/homepage4/play-icon.png"
                  alt="transp"
                />
                <span className="color-brand-2 wow animate__animated animate__fadeIn">
                  How it work ?<br />
                  Watch video tour
                </span>
              </a>
