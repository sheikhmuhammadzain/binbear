  ...
  return (
    <>
      <section className="section d-block">
        <div
          className="banner-1 banner-4 wow animate__animated animate__fadeIn"
          style={{
          ...
          <div className="container">
            <div className="row align-items-center">
              <div className="col-lg-12">
                <p className="font-md color-white mb-15 wow animate__animated animate__fadeIn">
                  junk Removal Solutions
                </p>
                <h1 className="color-white mb-25 wow animate__animated animate__fadeIn">
                  Same Day Junk Remval Service
                ...
                <div className="row">
                  <div className="col-lg-9">
                    <p className="font-md color-white mb-20 wow animate__animated animate__fadeIn">
                      ...
                      to always align with
                      <br className="d-none d-lg-block wow animate__animated animate__fadeIn" />
                      our client's business goals and objectives is what drives
                      mutual success.
                    </p>
                  </div>
                </div>
                  ...
                  <div className="box-search-2">
                    <div className="form-search d-flex">
                      <input
                        ...
                        defaultValue="Enter your postcode"
                      />
                      <a
                        className="btn btn-brand-1-big wow animate__animated animate__fadeIn"
