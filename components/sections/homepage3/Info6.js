        ...
        <div className="container">
          <div className="row align-items-center">
            <div className="col-lg-6 mb-50">
              <div className="box-image-why wow animate__animated animate__fadeIn">
                <img
                  src="/assets/imgs/page/homepage3/img-info-6.png"
                  alt="transp"
                />
                <div
                  className="box-button-play wow animate__animated animate__fadeIn"
            ...
            <div className="col-lg-6 mb-50">
              <div className="box-info-6">
                <span
                  className="btn btn-tag wow animate__animated animate__fadeIn"
                  style={{backgroundColor: "orange"}}
                >
                  Who We Are?
                </span>
                <h2 className="color-grey-900 mb-20 mt-15 wow animate__animated animate__fadeIn">
                  We are the world's leading Junk Removal service provider
                </h2>
                ...
                <div className="row">
                  <div className="col-lg-6 mb-30 wow animate__animated animate__fadeIn">
                    <h6 className="chart-title font-md-bold color-grey-900">
                  ...
                  <div className="col-lg-6 mb-30 wow animate__animated animate__fadeIn">
                    <h6 className="feature2-title font-md-bold color-grey-900">
                  ...
                  <div className="col-lg-6 mb-30 wow animate__animated animate__fadeIn">
                    <h6 className="feature3-title font-md-bold color-grey-900">
                      Introducing New Features
                    </h6>
                    <p className="font-xs color-grey-900">
                      The latest design trends meet hand-crafted templates.
