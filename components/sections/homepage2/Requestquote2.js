...
export default function Requestquote2() {
    return (
        <>
                    ...
                    <div className="row">
                        <div className="col-lg-6">
                            <div className="box-request-quote-2">
                                <h2 className="color-grey-900 mb-20 mt-15 wow animate__animated animate__fadeIn">Fast shipping
                                    with the most modern technology</h2>
                                ...
                                <div className="box-form-contact-leading">
                                    ...
                                    <div className="row align-items-center wow animate__animated animate__fadeIn">
                                        ...
                                        <div className="col-lg-12"><Link className="btn btn-brand-1-big mr-25 wow animate__animated animate__fadeIn" href="#"style={{backgroundColor:'orange'}}>
                                            ...
                                            </svg>Cost Calculation</Link><Link className="btn btn-link-medium wow animate__animated animate__fadeIn" href="/contact">Free Estimate
