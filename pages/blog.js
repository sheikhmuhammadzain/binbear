...
import {
  ...
  topicsData as fallbackTopicsData,
} from "@/data/blogData"
    ...
    const fetchBlogData = async () => {
      try {
        ...
        const popularBlogsData =
          popularBlogsResult.status === "fulfilled"
            ? popularBlogsResult.value
            : []
        ...
        if (blogs && blogs.length > 0) {
          ...
          const featuredBlogs = transformedBlogs.filter(
            blog => blog.is_featured === "Yes",
          )

          // Set the featured article (first featured blog or first blog if no featured)
          setFeaturedArticle(
            featuredBlogs.length > 0 ? featuredBlogs[0] : transformedBlogs[0],
          )
          ...
          if (popularBlogsData && popularBlogsData.length > 0) {
            ...
            if (popularBlogsResult.status === "rejected") {
              console.error(
                "Error fetching popular blogs:",
                popularBlogsResult.reason,
              )
            }
              ...
              <div className="row">
                ...
                <div className="col-lg-6">
                  <div className="estimator-content">
                    ...
                    <p>
                      Our convenient and easy-to-use online pricing estimator
                      makes getting an estimate* for your junk removal job fast
                      and simple.
                    </p>
                    <Link
                      href="/truck-load-estimate"
                      className="btn-get-estimate"
                    >
