  ...
  return (
    <>
      <Layout>
        ...
        >
          ...
          >
            <div className="banner text-center">
              <h1
                className="color-white mt-15 mb-30 wow animate__animated animate__fadeIn"
                style={{
                  fontSize: "48px",
                  fontWeight: "bold",
                  lineHeight: "1.2",
              ...
              <p
                className="font-lg color-white wow animate__animated animate__fadeIn mb-40"
                style={{
                  fontSize: "18px",
                  maxWidth: "600px",
                  margin: "0 auto 40px",
              ...
              >
                Professional, reliable, and eco-friendly commercial junk removal
              ...
              <div className="col-lg-6 mb-40">
                ...
                <div className="content-spacing">
                  <p className="font-md color-grey-900 wow animate__animated animate__fadeIn mb-25">
                    Every business, no matter the industry, generates junk. Over
                    time, old office furniture, equipment, and various forms of
                    debris tend to pile up. If your business is ready to clear
                    out the clutter, BinBear is here to help with affordable,
                    tailored commercial junk removal solutions.
                  </p>
                  <p className="font-md color-grey-900 wow animate__animated animate__fadeIn mb-30">
                    Whether you're dealing with outdated office furniture,
                    discarded electronics, or leftover construction materials,
                    we have the expertise and equipment to handle it all. Trust
                    BinBear, North America's top choice for commercial junk
                    removal.
                  </p>
                </div>
                ...
                <div className="row benefits-list">
                  <div className="col-lg-6 mb-30">
                    <div className="benefit-item">
                      <h6 className="chart-title font-md-bold color-grey-900 wow animate__animated animate__fadeIn mb-15">
                        Top-Rated Service
                      </h6>
                      <p className="font-xs color-grey-900 wow animate__animated animate__fadeIn">
                        Our commitment to reliability and professionalism
                        ensures exceptional value for your business.
                      </p>
                    </div>
                  </div>
                  <div className="col-lg-6 mb-30">
                    <div className="benefit-item">
                      ...
                      <p className="font-xs color-grey-900 wow animate__animated animate__fadeIn">
                        BinBear offers business accounts with convenient payment
                        options.
                      </p>
                    </div>
                  </div>
                  <div className="col-lg-12 mb-30">
                    <div className="benefit-item">
                      <h6 className="feature2-title font-md-bold color-grey-900 wow animate__animated animate__fadeIn mb-15">
                        Fully Insured
                      </h6>
                      <p className="font-xs color-grey-900 wow animate__animated animate__fadeIn">
                        You're protected, and so are we, as our team performs
                        junk removal on your property.
                      </p>
                    </div>
                  </div>
                </div>
              ...
              <div className="col-lg-6 mb-30">
                <div className="box-image-how">
                  <img
                    ...
                    src="/assets/imgs/page/trackyourparcel/img-info-7.png"
                    alt="Commercial Junk Removal"
                    style={{borderRadius: "15px"}}
                  />
                  <div
                    className="box-info-bottom-img"
                    style={{
                  ...
                  >
                    <div className="info-play wow animate__animated animate__fadeIn">
                      <h4 className="color-white mb-20">
                        We have 8 years passion and reputation
                      </h4>
                      <p className="font-sm color-white">
                        What started as small, locally owned junk hauling
                        business has quickly grown into a trusted name in our
                        community
                      </p>
                    </div>
                  </div>
          ...
          <div className="container">
            ...
            <div className="card-grid">
              {cards.map((card, index) => (
                <div key={index}>
                  <div
                    className={`cardService ${clickedCardIndex === index ? "clicked" : ""}`}
        ...
        {/* Benefits Section */}
        <section
          className="section-spacing bg-worldmap"
                  ...
                  >
                    <div className="info-play">
                      <h4 className="color-white mb-15 wow animate__animated animate__fadeIn">
                        8 Years of Passion and Reputation
                      </h4>
                ...
                <ul className="list-how-works">
                  <li className="mb-30">
                    ...
                    <div className="info-how" style={{marginLeft: "20px"}}>
                      <h5 className="color-black wow animate__animated animate__fadeIn mb-15">
                        Peace of Mind
                      </h5>
                      <p className="font-md color-grey-700 wow animate__animated animate__fadeIn">
                        Avoid the productivity loss and expenses associated with
                        DIY junk removal.
                      </p>
                    </div>
                  </li>
                  ...
                  <li className="mb-30">
                    ...
                    <div className="info-how" style={{marginLeft: "20px"}}>
                      ...
                      <p className="font-md color-grey-700 wow animate__animated animate__fadeIn">
                        Clear out excess equipment and furniture, improving the
                        safety and appearance of your workspace.
                      </p>
                    </div>
                  </li>
                  ...
                  <li className="mb-30">
                    ...
                    <div className="info-how" style={{marginLeft: "20px"}}>
                      ...
                      <p className="font-md color-grey-700 wow animate__animated animate__fadeIn">
                        Free up time by letting BinBear handle all your junk
                        removal needs.
                      </p>
                    </div>
                  </li>
                  ...
                  <li className="mb-30">
                    ...
                    <div className="info-how" style={{marginLeft: "20px"}}>
                      ...
                      <p className="font-md color-grey-700 wow animate__animated animate__fadeIn">
                        Our team is equipped to handle heavy and bulky items
                        safely, minimizing risks for your staff.
                      </p>
                    </div>
                  </li>
                </ul>
        ...
        <section className="section-spacing">
          <div className="container">
            <div className="row align-items-center">
              ...
              <div className="col-lg-6 mb-40">
                <img
                  className="mb-30 wow animate__animated animate__fadeIn"
                ...
                <p className="font-md color-grey-700 wow animate__animated animate__fadeIn">
                  ...
                  way with recycling-based junk removal. We sort each load to
                  separate metals, electronics, paper, and more, aiming to
                  recycle or repurpose as much as possible. Usable items are
                  donated to local charities, helping reduce landfill waste
        ...
        {/* Ready Section */}
        <section
          className="section-spacing-small"
          style={{backgroundColor: "#f8f9fa"}}
        >
          <div className="container">
            <div className="row align-items-center">
              <div className="col-lg-6 mb-40">
                ...
                <ul className="list-how-works">
                  <li className="wow animate__animated animate__fadeIn mb-30">
                    ...
                    <div className="info-how" style={{marginLeft: "20px"}}>
                      <h5 className="color-black mb-10">
                        Schedule Your Appointment
                      </h5>
                      <p className="font-md color-grey-700">
                        Book online or call us to set up a time that works for
                        you.
                      </p>
                    </div>
                  </li>
                  ...
                  <li className="wow animate__animated animate__fadeIn mb-30">
                    ...
                    <div className="info-how" style={{marginLeft: "20px"}}>
                      ...
                      <p className="font-md color-grey-700">
                        Our team will arrive on time, assess the volume of junk,
                        and provide an upfront estimate.
                      </p>
                    </div>
                  </li>
                  ...
                  <li className="wow animate__animated animate__fadeIn mb-30">
                    ...
                    <div className="info-how" style={{marginLeft: "20px"}}>
                      ...
                      <p className="font-md color-grey-700">
                        We handle all the heavy lifting, loading, and hauling,
                ...
                <p className="font-md color-grey-700 wow animate__animated animate__fadeIn mt-30">
                  Our professional team is insured and dedicated to providing
                  top-notch service with no hidden fees. Whether it's old office
                  furniture, construction debris, or unwanted electronics,
                  BinBear has you covered.
                </p>
              </div>
            ...
            <div className="row align-items-center mb-40">
              <div className="col-lg-8 col-md-8 mb-30">
                <p className="font-md color-gray-700 wow animate__animated animate__fadeIn">
                  Professional removal services for all types of commercial and
                  residential needs.
                </p>
              </div>
              ...
              <div className="row" style={{alignItems: "stretch"}}>
                {[
                  ...
                  },
                  {
                    ...
                    description:
                      "Eco-friendly yard waste collection and disposal",
                  },
                  {
                    title: "Hot Tub Removal",
                    description: "Safe and efficient hot tub removal services",
                  },
                  {
                    title: "Trash Removal",
                    description: "Comprehensive trash and waste removal",
                  },
                  {
                    title: "Mattress Disposal",
                    description: "Responsible mattress disposal and recycling",
                  },
                  {
                    title: "Refrigerator Disposal & Recycling",
                    description: "Environmentally safe appliance disposal",
                  },
                  {
                    title: "E-Waste Disposal",
                    description:
                      "Secure electronic waste disposal and recycling",
                  },
                  {
                    title: "General Garbage Removal",
                    description: "All-purpose garbage collection services",
                  },
                ].map((service, index) => (
                  <div
                    className="col-lg-4 col-md-6 wow animate__animated animate__fadeIn d-flex"
                    key={index}
                  >
                    <div
                      className="card-offer hover-up service-card"
                      style={{
                        backgroundImage:
                          "url('/assets/imgs/page/workprocess/background.png')",
                    ...
                    >
                      ...
                      >
                        <div>
                          ...
                          <p
                            className="font-sm color-white mb-25"
                            style={{
                              fontSize: "14px",
                              lineHeight: "1.5",
                              flex: "1",
          ...
          <div className="container">
            ...
            >
              <div className="get-quote-left">
                <p
                  className="font-3xl color-white mb-10 wow animate__animated animate__fadeIn"
                  style={{fontSize: "32px", marginBottom: "15px"}}
                >
                  When you think Junk, think BinBear!
                </p>
                <h3
                  className="color-brand-wow animate__animated animate__fadeIn"
                  style={{
                    color: "#FF7F00",
                    fontSize: "24px",
                    fontWeight: "bold",
