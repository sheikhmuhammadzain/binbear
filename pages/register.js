...
const Brand1Slider = dynamic(() => import("@/components/slider/Brand1Slider"), {
  ssr: false,
})
          ...
          <div className="row align-items-center m-0">
            <div className="col-lg-6" style={{marginBottom: "500px"}}>
              <div className="box-login-left">
                <h2 className="color-black mb-10 wow animate__animated animate__fadeIn">
                  Create an account
                </h2>
            ...
            <div className="col-lg-6">
              <div className="box-login-right box-register-right">
                ...
                <div className="box-info-bottom-img-3">
                  <div
                    className="box-info-3-bottom"
                    style={{backgroundColor: "black"}}
                  >
                    <h3 className="color-white mb-10 wow animate__animated animate__fadeIn">
                      Warehousing
                    </h3>
                    <p
                      className="font-sm color- wow animate__animated animate__fadeIn"
                      style={{color: "white"}}
                    >
                    ...
                    <div className="mt-30 wow animate__animated animate__fadeIn">
                      <Link
                        className="btn btn-link font-sm color-white"
                        href="#"
                      >
                        View Details
                        <span>
