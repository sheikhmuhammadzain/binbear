...
>Get an Estimate Now With our Online Pricing Estimator!
                               ...
                               <p className="font-md color-grey-700 wow animate__animated animate__fadeIn"style={{marginTop:'20px'}} > 
Our pricing estimator even allows you to estimate based on the space your junk will take up in our large removal trucks. Get an affordable estimate in just minutes!
</p>
  ...
  h2 {
    ...
    text-align: center;  /* Keep the text centered on small screens */
                          ...
                          `}
                                ...
                                <ul className="list-how-works">
                                    ...
                                    <li className="wow animate__animated animate__fadeIn">
                                        ...
                                        <div className="info-how">
                                            ...
                                            Our team arrives on schedule with big, green trucks ready to handle your junk removal.
                                            </p>
                                        </div>
                                    </li>
                                ...
                                <p className="font-md color-grey-700 wow animate__animated animate__fadeIn"style={{marginBottom:'20px'}}>No job is too big or too small for BinBear, and our pricing reflects our commitment to value. </p>
